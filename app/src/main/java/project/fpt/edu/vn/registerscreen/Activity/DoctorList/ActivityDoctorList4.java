...
public class ActivityDoctorList4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(name.equals("Bệnh tâm lý")){
            socketApplication.getSocket().emit("patient_load_doctor","4");
        }
        adapter = new ListAdapter(
                ActivityDoctorList4.this,
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(ActivityDoctorList4.this, DoctorProfileActivity.class);
    ...
    private void Logout(){
        ...
        finish();
        startActivity(new Intent(ActivityDoctorList4.this, LoginActivity.class));
    }
    private void doBindService() {
        bindService(new Intent(ActivityDoctorList4.this, SocketServiceProvider.class), socketConnection, Context.BIND_AUTO_CREATE);
        mIsBound = true;
    }
    @Override
