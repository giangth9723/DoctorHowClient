...
public class FemaleListAdapter extends ArrayAdapter<Emr_female> {
    public FemaleListAdapter(Context context, int resource, List<Emr_female> items){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Emr_female el = getItem(position);
