...
public class ActivityDoctorListFemale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(ActivityDoctorListFemale.this, DoctorProfileActivity.class);
    ...
    private void Logout(){
        ...
        finish();
        startActivity(new Intent(ActivityDoctorListFemale.this, LoginActivity.class));
    }
    private void doBindService() {
        bindService(new Intent(ActivityDoctorListFemale.this, SocketServiceProvider.class), socketConnection, Context.BIND_AUTO_CREATE);
        mIsBound = true;
    }
    @Override
    ...
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void onMessageEvent(EventReloadDoctorOnline1 event) {
        Log.d("ListDoctorOnline1","True");
        arrayDoctorOnline.clear();
        for(int i=0;i< event.getArrayDoctor().size();i++){
            if(event.getArrayDoctor().get(i).getOnline_status().equalsIgnoreCase("online")) {
                arrayDoctorOnline.add(event.getArrayDoctor().get(i));
