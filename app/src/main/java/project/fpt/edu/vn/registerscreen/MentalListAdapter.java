...
public class MentalListAdapter extends ArrayAdapter<Emr_mental> {
    public MentalListAdapter(Context context, int resource, List<Emr_mental> items){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Emr_mental el = getItem(position);
